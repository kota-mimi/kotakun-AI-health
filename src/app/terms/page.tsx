        ...
        <div className="bg-white/80 backdrop-blur-sm shadow-lg rounded-lg p-8">
          ...
          <div className="space-y-6 text-gray-700">
            <section>
              ...
              <p>
                本利用規約（以下「本規約」）は、こたくん（以下「当社」または「運営者」）が提供する
                健康管理AIサポートサービス「こたくん」（以下「本サービス」）の利用条件を定めるものです。
                利用者（以下「ユーザー」）は、本サービスを利用することにより、本規約の全条項に同意したものとみなします。
              </p>
            </section>
            ...
            <section>
              ...
              <div className="ml-4">
                ...
                <ol className="list-decimal ml-6 space-y-1">
                  ...
                  <li>「健康データ」とは、体重、身長、食事記録、運動記録、体調記録等の健康に関する一切のデータをいいます</li>
            ...
            <section>
              ...
              <div className="ml-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">3.1 基本機能（無料プラン）</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                  <li>LINE公式アカウントを通じた健康相談（1日5通まで）</li>
                  <li>LINEを通じた食事・運動記録（1日2通まで）</li>
                  <li>基本的なデータ記録・閲覧機能</li>
                  <li>体重・体調の簡易記録</li>
                </ul>
                
                <h3 className="font-medium mb-2 text-gray-800">3.2 プレミアム機能（有料プラン）</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">3.3 技術仕様</h3>
            ...
            <section>
              ...
              <div className="ml-4">
                <h3 className="font-medium mb-2 text-gray-800">4.1 アカウント登録</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">4.2 年齢制限</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">4.3 利用資格の停止・削除</h3>
                <ul className="list-disc ml-6 space-y-1">
            ...
            <section>
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-4">
                <h3 className="font-semibold text-red-800 mb-2">❗ 重要な免責事項</h3>
                <ul className="list-disc ml-6 space-y-1 text-red-700">
                  <li><strong>本サービスは健康管理のサポートを目的としており、医療行為ではありません</strong></li>
                  <li><strong>本サービスの情報は診断、治療、医学的助言を意図したものではありません</strong></li>
                  <li><strong>健康上の問題や症状がある場合は、必ず医師や医療機関にご相談ください</strong></li>
                  <li><strong>本サービスの利用により生じた健康上の問題、损害、不利益について、当社は一切の責任を負いません</strong></li>
                </ul>
              </div>
              
              <div className="ml-4">
                <h3 className="font-medium mb-2 text-gray-800">5.1 サービスの性質に関する理解</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">5.2 ユーザーの責任</h3>
                <ul className="list-disc ml-6 space-y-1">
                  ...
                  <li>妖娠中、授乳中の方は、医師の指導の下で利用してください</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="ml-4">
                <h3 className="font-medium mb-2 text-gray-800">6.1 料金体系</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">6.2 決済方法・自動更新</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">6.3 キャンセル・返金ポリシー</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">6.4 料金の未払い・遅延</h3>
                <ul className="list-disc ml-6 space-y-1">
            ...
            <section>
              ...
              <div className="ml-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">7.1 アカウント・情報に関する禁止行為</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                  <li>虚偽の個人情報や健康データを登録すること</li>
                  <li>他人のアカウントや個人情報を無断で使用・登録すること</li>
                  <li>アカウントを第三者に譲渡、貨与、共有すること</li>
                  <li>自分以外の人物の健康データを登録すること</li>
                </ul>
                
                <h3 className="font-medium mb-2 text-gray-800">7.2 システム・セキュリティに関する禁止行為</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">7.3 コンテンツ・情報に関する禁止行為</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">7.4 商業利用・不正利用</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                  <li>当社の許可なく商業目的で本サービスを利用すること</li>
                  <li>本サービスの情報を第三者に販売、提供、再配布すること</li>
                  <li>競合他社のサービス開発や運営のために本サービスを利用すること</li>
                  <li>アフィリエイト、MLM、ネットワークビジネス等の勧誘</li>
                </ul>
                
                <h3 className="font-medium mb-2 text-gray-800">7.5 その他の禁止行為</h3>
                <ul className="list-disc ml-6 space-y-1">
                  <li>法令、公序良俗、社会通念に反する行為</li>
                  <li>本サービスの運営を妨害し、信用を失墓させる行為</li>
                  <li>他のユーザーや第三者に迷惑、不利益、损害を与える行為</li>
                  <li>日本国外からのアクセス（サービス対象地域外からの利用）</li>
            ...
            <section>
              ...
              <div className="ml-4">
                <h3 className="font-medium mb-2 text-gray-800">8.1 サービスの知的財産権</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">8.2 ユーザーが登録するデータの扱い</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">8.3 AI技術の利用に関する同意</h3>
                <ul className="list-disc ml-6 space-y-1">
                  <li>ユーザーは、登録した健康データがAI技術により分析・処理されることに同意します</li>
                  <li>AIによる分析結果は参考情報であり、医学的精度や完全性を保証するものではありません</li>
                  <li>当社は、AI技術の改善のために、匪名化されたデータを機械学習のトレーニングに使用する場合があります</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="ml-4">
                <h3 className="font-medium mb-2 text-gray-800">9.1 サービスの変更</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">9.2 サービスの一時中断</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="font-medium mb-2 text-gray-800">9.3 サービスの終了</h3>
                <ul className="list-disc ml-6 space-y-1">
                  <li>当社は、ユーザーに3ヶ月前に通知することにより、本サービスの提供を終了できます</li>
                  <li>サービス終了時は、ユーザーデータのエクスポート機能を一定期間提供いたします</li>
                  <li>サービス終了によりユーザーに生じた损害について、当社は責任を負いません</li>
                </ul>
              </div>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">第10条（免責事項・損害資任の制限）</h2>
              <div className="ml-4">
                <h3 className="font-medium mb-2 text-gray-800">10.1 当社の免責事項</h3>
                <p className="mb-3">当社は、以下の事項について一切の責任を負いません：</p>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                  ...
                  <li>アカウントの不正利用、パスワード漏洩等による损害</li>
                  <li>自然災害、戦争、テロ、政府の規制等の不可抗力による損害</li>
                  <li>本サービスの利用に関連して発生した、直接、間接、付随的、特別、結果的损害</li>
                </ul>
                
                <h3 className="font-medium mb-2 text-gray-800">10.2 損害責任の制限</h3>
                <ul className="list-disc ml-6 space-y-1 mb-4">
                  <li>万一、当社に法的責任が発生した場合でも、その損害責任は直接かつ通常の損害に限定されます</li>
                  <li>損害貺償金の上限は、ユーザーが当社に支払った料金の直近て3ヶ月分の合計金額を上限とします</li>
                  <li>無料プラン利用者に対する損害貪償責任は一切負いません</li>
                </ul>
                
                <h3 className="font-medium mb-2 text-gray-800">10.3 ユーザーの損害貪償責任</h3>
                <ul className="list-disc ml-6 space-y-1">
                  <li>ユーザーが本規約に違反し、当社または第三者に損害を与えた場合、ユーザーがその損害を貪償するものとします</li>
                  <li>ユーザーの禁止行為により当社が被った损害（弁護士費用、人件費等を含む）は、ユーザーが負担するものとします</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium mb-2">8.1 サービスの変更</h3>
                  <p>
                    当社は、サービスの改善、技術的要因、法的要因、または事業戦略の変更により、
                    本サービスの全部または一部の内容を変更することができます。
                    重要な変更については、実施の30日前までにアプリ内通知またはウェブサイトにて告知いたします。
                  </p>
                </div>
                <div>
                  <h3 className="font-medium mb-2">8.2 サービスの一時停止</h3>
                  <p>
                    当社は、以下の場合には、ユーザーに事前に通知することなく、
                    本サービスの全部または一部の提供を一時的に停止することができます：
                  </p>
                  <ul className="list-disc ml-6 mt-2 space-y-1">
                    <li>システムの保守・点検を定期的に行う場合</li>
                    <li>火災、停電、自然災害等の不可抗力により提供が困難な場合</li>
                    <li>システムの障害、過重な負荷等により正常な提供が困難な場合</li>
                    <li>その他、運営上または技術上の理由により必要と判断した場合</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-medium mb-2">8.3 サービスの終了</h3>
                  <p>
                    当社は、事業戦略の変更、採算性の悪化、その他の理由により、
                    本サービスの提供を終了することができます。
                    この場合、終了予定日の3ヶ月前までにユーザーに通知いたします。
                    サービス終了時点で有効な有料プランについては、
                    未利用期間に応じた返金または代替サービスの提供を行います。
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">第9条（分離可能性）</h2>
              <p>
                本規約のいずれかの条項が無効、違法または執行不能と判断された場合でも、
                本規約の他の条項の有効性は影響を受けません。
                無効と判断された条項については、本規約の目的を達成するために
                必要な範囲で有効な条項に修正されるものとします。
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">第10条（権利の譲渡禁止）</h2>
              <p>
                ユーザーは、当社の事前の書面による同意なく、
                本規約に基づく権利または義務の全部または一部を第三者に譲渡、
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  <h3 className="font-medium mb-2">11.1 準拠法</h3>
                  <p>
                    本規約およびサービスの利用に関しては、日本法を準拠法とし、
                    日本法に従って解釈されるものとします。
                  </p>
                </div>
                <div>
                  <h3 className="font-medium mb-2">11.2 管轄裁判所</h3>
                  <p>
                    本サービスまたは本規約に関連して生じた紛争については、
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">第12条（規約の変更）</h2>
              <div className="space-y-3">
                <div>
                  <h3 className="font-medium mb-2">12.1 変更の権利</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-medium mb-2">12.2 変更の通知</h3>
                  <p>
                    規約の変更については、変更内容および効力発生日を、
                    効力発生日の30日前までに本ウェブサイトまたはアプリ内にて告知いたします。
                    ユーザーが変更後の規約に同意いただけない場合は、
                    効力発生日前にサービスの利用を停止してください。
                  </p>
                </div>
                <div>
                  <h3 className="font-medium mb-2">12.3 変更への同意</h3>
                  <p>
                    変更後の規約の効力発生日以降もサービスを継続してご利用いただいた場合、
                    変更後の規約にご同意いただいたものとみなします。
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="font-medium">こたくん ヘルスケアサービス カスタマーサポート</p>
                  <p>メール: support@kotakun-health.jp</p>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  本規約は、「こたくん」ブランドで提供される健康管理サービスに適用されます。
                </p>
              </div>
            </div>
          </div>
