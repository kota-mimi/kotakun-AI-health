            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-3 rounded text-sm">
                    <p><strong>連絡先：</strong><a href="mailto:healthy.contact.line@gmail.com" className="text-blue-600 hover:text-blue-800 underline">healthy.contact.line@gmail.com</a></p>
