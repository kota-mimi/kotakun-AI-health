...
- 箇条書きは「・」で始める
- 各項目は基本150-200文字で具体的に書く（記録が少ない場合は短くてもOK）
...
良かった点:
・[食事・栄養で良かったことを親しみやすく褒める]

改善点:
・[食事・栄養で改善すべき点を親しみやすく提案]

■ 運動評価

良かった点:
・[運動・身体活動で良かったことを親しみやすく褒める]

改善提案:
・[運動・身体活動で改善すべき点のみを親しみやすく提案。褒める内容は絶対に書くな！運動時間の長さに関する改善案も出すな！改善点のみ！]
