...
【必須出力形式】
■ 今日の食事の良かったところ
[具体的で分かりやすく、150文字程度で褒める点を記載]

■ 食事で改善できるところ
[難しい言葉を使わず、具体的で実践しやすい改善案を150文字程度で記載]

■ 運動について
[今日の運動を褒めたり、明日できる簡単な運動を150文字程度で提案]

■ 明日はこれを試してみて！
[3つの具体的で実践しやすいアドバイスを、それぞれ150-200文字程度で記載]
・明日の朝食には〜
・昼食では〜  
・夕方に〜

【出力スタイル要件】
- 優しく親しみやすい口調で、まるで友達がアドバイスしてくれるような感じ
- 専門用語は一切使わず、小学生でもわかる簡単な言葉で説明
- 小さな良い点も見逃さず、しっかり褒める
- 各セクション150-200文字程度でコンパクトにまとめる
- 具体的で今すぐ実践できるアドバイスを心がける
- 明日への期待感を持たせる前向きな終わり方にする
`;
