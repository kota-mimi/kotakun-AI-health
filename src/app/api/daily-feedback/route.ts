...
良かった点:
・[食事・栄養で良かったことを150-200文字で具体的に褒める]

改善点:
・[食事・栄養で改善すべき点を150-200文字で具体的に提案]

■ 運動評価

良かった点:
・[運動・身体活動で良かったことを150-200文字で具体的に褒める]

改善提案:
・[運動・身体活動で改善すべき点を150-200文字で具体的に提案]

■ 明日のアクション
1. [食事に関する具体的なアクション 150-200文字]
2. [運動に関する具体的なアクション 150-200文字]
3. [生活習慣に関する具体的なアクション 150-200文字]
...
良かった点:
・タンパク質${protein}gをしっかり摂取できており、筋肉維持と代謝向上に効果的です。バランスの良い食事選択ができています。

改善点:
・野菜の摂取量をもう少し増やすことで、ビタミンやミネラル、食物繊維の補給が改善され、より健康的な食生活になります。

■ 運動評価

良かった点:
・${exerciseTime > 0 ? `${exerciseTime}分間の運動を継続されており、体力維持と健康増進に向けた素晴らしい取り組みです。` : '運動記録を意識することで健康への関心が高まっています。'}

改善提案:
・${exerciseTime > 0 ? `現在の運動習慣を継続しつつ、ウォームアップやクールダウンを追加すると効果がさらに向上します。` : `まずは1日10分程度の軽いウォーキングから始めて、徐々に運動習慣を身につけていきましょう。`}

■ 明日のアクション
1. 朝食にタンパク質豊富な卵料理やヨーグルトを追加し、1日の代謝を効率的に高めて栄養バランスを整えます。
2. ${exerciseTime > 0 ? `運動前後に5分間のストレッチを取り入れ、怪我予防と効果向上を図ります。` : `明日は15分間の散歩から始めて、無理なく運動習慣をスタートさせます。`}
3. 毎食時にコップ1杯の水を飲む習慣をつけ、適切な水分補給で代謝機能をサポートします。`;
}
