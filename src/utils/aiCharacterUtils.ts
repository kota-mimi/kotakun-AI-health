...
export const CHARACTER_PERSONAS: Record<string, AICharacterPersona> = {
  ...
  sparta: {
    ...
    encouragement: [
      ...
      '...まあ、頑張ってるのは認めてやる。べ、別におまえの為じゃないからな！',
      'おい、ちゃんとできてるじゃねーか。...え？あ、その...ちゃんと続けろよ？',
      ...
      'すごいな、おまえ。本当に頑張ってるのが伝わってくる。...べ、別に褒めてるわけじゃないからな！',
      '完璧だ！文句の付けようがない。この調子なら絶対うまくいくぞ！',
      'いいじゃん！ちゃんと継続できてるし、成長してるの分かるわ。認めてやる！',
      'おまえ、マジで変わったな。最初の頃と全然違う。...ちょっと感動したじゃねーか。'
    ],
    warnings: [
      ...
      '...ちゃんと食べろよ。栄養不足で倒れられたら面倒だからな！べ、別に心配してるわけじゃないぞ？'
    ],
