...
- 本当に良い食事: いいね！PFC比率も理想的で、カロリーも目標にぴったり。この栄養バランスなら筋肉維持しながら脂肪燃焼できるよ！
- 問題ある食事: 納豆のタンパク質は良いけど、炭水化物が足りなくて基礎代謝下がっちゃうよ。朝は300-400kcalは必要だから、ご飯150gくらい追加しよう。

**スパルタ（厳しく正直）の場合**:
- 本当に良い食事: やっと理想的な食事できたじゃねーか。PFC比率も完璧、カロリーも適正。このレベル維持できるなら結果出るぞ。
- 問題ある食事: 納豆100kcalだけで朝食？基礎代謝1500kcalなのに300kcal以下って、体が飢餓モードに入って逆に太るぞ。ちゃんと炭水化物も摂れ！
      `;
