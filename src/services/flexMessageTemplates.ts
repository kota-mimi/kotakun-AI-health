            ...
            contents: [
              // 良いところ
              {
                ...
                contents: [
                  ...
                  {
                    type: 'text',
                    text: (analysis.personalizedAdvice && analysis.personalizedAdvice.positivePoints) || 'あなたの頑張りを評価しています。',
                    size: 'xs',
                    color: '#374151',
                    wrap: true,
                    margin: 'xs'
              ...
              // 改善ポイント  
              {
                ...
                contents: [
                  ...
                  {
                    type: 'text',
                    text: (analysis.personalizedAdvice && analysis.personalizedAdvice.improvements) || '継続的な取り組みが重要です。',
                    size: 'xs',
                    color: '#374151',
                    wrap: true,
                    margin: 'xs'
              ...
              // アドバイス
              {
                ...
                contents: [
                  ...
                  {
                    type: 'text',
                    text: (analysis.personalizedAdvice && analysis.personalizedAdvice.advice) || '健康的な生活を心がけましょう。',
                    size: 'xs',
                    color: '#374151',
                    wrap: true,
                    margin: 'xs'
