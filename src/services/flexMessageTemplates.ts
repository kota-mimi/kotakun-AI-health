        ...
        contents: [
          ...
          },
          {
            ...
            contents: [
              ...
              {
                type: 'text',
                text: extractSectionFromText(feedbackText, '■ 運動評価', '■ 明日のアクション').split('改善提案:')[0].replace('良かった点:', '') || '・継続的な運動習慣が素晴らしいです',
                size: 'sm',
                color: '#333333',
                wrap: true,
                margin: 'sm'
              ...
              {
                type: 'text',
                text: extractSectionFromText(feedbackText, '■ 運動評価', '■ 明日のアクション').split('改善提案:')[1] || '・筋トレと有酸素のバランスを意識\n・運動前後のストレッチを追加',
                size: 'sm',
                color: '#333333',
                wrap: true,
                margin: 'sm'
