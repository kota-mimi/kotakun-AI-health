              ...
              <>
                ...
                {bmrData ? (
                  <div className="flex space-x-1.5">
                    ...
                    <div className="flex-1 text-center p-2 bg-amber-50 rounded border border-amber-100">
                      <div className="text-xs text-amber-600">基礎代謝</div>
                      <div className="font-bold text-amber-900 text-sm">{Math.round(bmrData)}kcal</div>
                    </div>
                  </div>
                ) : (
