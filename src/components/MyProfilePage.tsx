              ...
              <>
                ...
                {bmrData ? (
                  <div className="flex space-x-1.5">
                    ...
                    <div className="flex-1 text-center p-2 bg-gradient-to-br from-orange-50 to-orange-100/50 rounded border border-orange-200/50" style={{background: 'linear-gradient(to bottom right, #fff7ed, rgba(251, 146, 60, 0.5))'}}>
