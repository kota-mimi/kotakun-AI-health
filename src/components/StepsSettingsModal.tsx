...
export function StepsSettingsModal({ isOpen, onClose, onSave }: StepsSettingsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-md bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl border border-white/30 rounded-xl shadow-2xl mx-auto">
        <DialogHeader>
