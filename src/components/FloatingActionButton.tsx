            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* ツールチップ */}
                  <div className="absolute right-16 top-1/2 transform -translate-y-1/2 bg-white text-slate-800 text-sm font-medium px-3 py-2 rounded-xl shadow-2xl shadow-blue-500/10 border border-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                    {action.label}
