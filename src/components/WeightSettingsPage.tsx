          ...
          <div className="space-y-3">
            ...
            {settings.morningWeight && (
              <div className="p-3 bg-green-50 rounded-lg border border-green-100">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-green-700">朝の体重</span>
                  <span className="text-sm text-green-800">72.1kg</span>
                </div>
                <div className="text-xs text-green-600">有効 - 別ラインで表示されます</div>
              </div>
            )}
            ...
            {settings.eveningWeight && (
              <div className="p-3 bg-purple-50 rounded-lg border border-purple-100">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-purple-700">夜の体重</span>
                  <span className="text-sm text-purple-800">72.9kg</span>
                </div>
                <div className="text-xs text-purple-600">有効 - 別ラインで表示されます</div>
              </div>
            )}
          </div>
        </Card>
